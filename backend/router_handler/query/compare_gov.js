...
exports.gov_compare_subject = function (req, res) {
	...
	for(let i = 0;i<params.length;i++){
		school_comp_sub = school_comp_sub+"'"+params[i]+"'"
		if(i!=params.length-1){
			school_comp_sub+=","
		}
	}
	console.log(school_comp_sub);
...
LEFT JOIN (
	...
	INNER JOIN discipline_eval ON a.univ_code = discipline_eval.univ_code AND a.discipline_code = discipline_eval.discipline_code
...
) as a1 ON a1.univ_code = all_xk.univ_code AND a1.discipline_code = all_xk.discipline_code
LEFT JOIN(
	SELECT
		a.univ_code,
		a.discipline_code,
	...
	INNER JOIN discipline_influ ON a.univ_code = discipline_influ.univ_code AND a.discipline_code = discipline_influ.discipline_code
	INNER JOIN user_fill ON user_fill.ID = discipline_influ.user_fill_id 
WHERE
	user_fill.is_delete = '0' 
	AND user_fill.is_seen = '1'
	AND discipline_influ.is_delete = '0'
	AND rank_type = '软科中国大学专业排名'
	AND yr ='2022'
) as a2 ON a2.univ_code = all_xk.univ_code AND a2.discipline_code = all_xk.discipline_code
LEFT JOIN(
	SELECT
	univ_code,
	discipline_code,
...
) as a3 ON a3.univ_code = all_xk.univ_code AND a3.discipline_code = all_xk.discipline_code
LEFT JOIN(
	SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a4 ON a4.univ_code = all_xk.univ_code AND a4.discipline_code = all_xk.discipline_code
LEFT JOIN (
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a5 ON a5.univ_code = all_xk.univ_code AND a5.discipline_code = all_xk.discipline_code
LEFT JOIN (
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a6 ON a6.univ_code = all_xk.univ_code AND a6.discipline_code = all_xk.discipline_code
LEFT JOIN (
SELECT
	univ_code,
	discipline_code,
...
)as a7 ON a7.univ_code = all_xk.univ_code AND a7.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
)as a8 ON a8.univ_code = all_xk.univ_code AND a8.discipline_code = all_xk.discipline_code
LEFT JOIN (
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a9 ON a9.univ_code = all_xk.univ_code AND a9.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a10 ON a10.univ_code = all_xk.univ_code AND a10.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
)as a11 ON a11.univ_code = all_xk.univ_code AND a11.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
WHERE
	...
	AND pdoc_ra.yr = '2022'
)as a12 ON a12.univ_code = all_xk.univ_code AND a12.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
WHERE
	...
	AND discipline_const_fund.is_delete = '0'
	AND discipline_const_fund.yr = '2022'
)as a13 ON a13.univ_code = all_xk.univ_code AND a13.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a14 ON a14.univ_code = all_xk.univ_code AND a14.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a15 ON a15.univ_code = all_xk.univ_code AND a15.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
WHERE
	...
	AND tch_attdrpt_acconf.yr = '2022'
GROUP BY
	univ_code,
	discipline_code
)as a16 ON a16.univ_code = all_xk.univ_code AND a16.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a17 ON a17.univ_code = all_xk.univ_code AND a17.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a18 ON a18.univ_code = all_xk.univ_code AND a18.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a19 ON a19.univ_code = all_xk.univ_code AND a19.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a20 ON a20.univ_code = all_xk.univ_code AND a20.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a21 ON a21.univ_code = all_xk.univ_code AND a21.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
	touniv_scifund.yr as zh_yr,
	SUM(total_fund) as z_fund ---年度纵向经费总和
FROM 
	touniv_scifund
...
WHERE
	user_fill.is_delete = '0'
	AND user_fill.is_seen = '1'	
	AND touniv_scifund.is_delete = '0' 
	AND touniv_scifund.subj_type = '纵向'
	AND touniv_scifund.yr = '2022'
GROUP BY
	univ_code,
	discipline_code,
	touniv_scifund.yr
)as a22 ON a22.univ_code = all_xk.univ_code AND a22.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
	touniv_scifund.yr as zh_yr,
	SUM(total_fund) as h_fund ---年度横向经费总和
FROM 
	touniv_scifund
	INNER JOIN user_fill ON user_fill.ID = touniv_scifund.user_fill_id 
WHERE
	...
	AND user_fill.is_seen = '1'	
	AND touniv_scifund.is_delete = '0' 
	AND touniv_scifund.subj_type = '横向'
	AND touniv_scifund.yr = '2022'
GROUP BY
	univ_code,
	discipline_code,
	touniv_scifund.yr
)as a23 ON a23.univ_code = all_xk.univ_code AND a23.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
WHERE
	...
	AND achv_to_univfund.yr='2022'
GROUP BY
	univ_code,
	discipline_code,
	atu_yr
)as a24 ON a24.univ_code = all_xk.univ_code AND a24.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a25 ON a25.univ_code = all_xk.univ_code AND a25.discipline_code = all_xk.discipline_code
LEFT JOIN(
SELECT
	univ_code,
	discipline_code,
...
GROUP BY
	univ_code,
	discipline_code
)as a26 ON a26.univ_code = all_xk.univ_code AND a26.discipline_code = all_xk.discipline_code
WHERE concat_ws('-',all_xk.univ_name,all_xk.discipline_name) IN (${school_comp_sub})	--传参数`
	console.log(xkq_xk_sql);
	var sqls = []
	sqls.push(xkq_xk_sql)
	...
	async.eachSeries(sqls, function(item, callback){
		...
		if (err) {
			...
			for(let i =0;i<results_all.rows.length; i++){
				arr[i] = results_all.rows[i].dis_name.split('-')
				arr[i][0] = '\'' + arr[i][0] + '\''
				arr[i][1] = '\'' + arr[i][1] + '\''
				var temp_json = {}
				temp_json.school = arr[i][0].substring(1, arr[i][0].length-1)
