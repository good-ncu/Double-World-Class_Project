...
const data_5_2_1_1 = joi.array().items(
    joi.object().keys({
        ...
        palt_level:joi.string().valid('国家级','省级').required().error(new Error(new Error('平台级别填报错误！'))),
        appro_date:joi.string().pattern(/^(1[9][5-9][0-9]|2[0][0-2][0-9])-(0[1-9]|1[0-2])$/).error(new Error('批准时间填写错误！')),
