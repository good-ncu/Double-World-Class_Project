 ...
 */
// 手动 填报 学科入选国家优秀教师先进典型 情况路由（3-1-1）
router.post('/teacher-morality/honor-counts-template',public.upload_file_callback,excel_parsing3.deal_table_3_1_1,expressJoi(sub_schema3.table_3_1_1), teacher_team_handler.honor_counts_sub)
 ...
 */
// 手动 填报 学科主要方向、学科带头人及中青年学术骨干清单 情况路由（表格3-2-1）
router.post('/major-teacher/subject-counts-template',public.upload_file_callback,excel_parsing3.deal_table_3_2_1,expressJoi(sub_schema3.table_3_2_1), teacher_team_handler.subject_counts_sub)

// 手动 填报 高层次人才及团队存量清单 情况路由（表3-2-2-0）
router.post('/major-teacher/personnel-team/all-counts-template',public.upload_file_callback,excel_parsing3.deal_table_3_2_2_0,expressJoi(sub_schema3.table_3_2_2_0), teacher_team_handler.all_counts_sub)

// 手动 填报 国家级团队和学术领军人才（含青年人才）清单 情况路由（表3-2-2-1）
router.post('/major-teacher/personnel-team/nation-counts-template',public.upload_file_callback,excel_parsing3.deal_table_3_2_2_1,expressJoi(sub_schema3.table_3_2_2_1), teacher_team_handler.nation_counts_sub)

// 手动 填报 省重点人才清单 情况处理函数 情况路由（表3-2-2-2）
router.post('/major-teacher/personnel-team/province-counts-template',public.upload_file_callback,excel_parsing3.deal_table_3_2_2_2,expressJoi(sub_schema3.table_3_2_2_2), teacher_team_handler.province_counts_sub)

// 手动 填报 表3-2-3 学科专任教师数量及结构
router.post('/major-teacher/number-struct-template',public.upload_file_callback,excel_parsing3.deal_table_3_2_3,expressJoi(sub_schema3.table_3_2_3), teacher_team_handler.number_struct_sub)

// 手动 填报 表3-2-4 博士后和科研助理数量
router.post('/major-teacher/assistant-counts-template',public.upload_file_callback,excel_parsing3.deal_table_3_2_4,expressJoi(sub_schema3.table_3_2_4), teacher_team_handler.assistant_counts_sub)

// 手动 填报 表3-2-5 外籍专任教师数量及结构
router.post('/major-teacher/foreign-teacher-template',public.upload_file_callback,excel_parsing3.deal_table_3_2_5,expressJoi(sub_schema3.table_3_2_5), teacher_team_handler.foreign_teacher_sub)
 ...
 */
// 手动 填报 表3-3-1 教师担任国内外重要期刊负责人清单
router.post('/International-level/journal-director-template',public.upload_file_callback,excel_parsing3.deal_table_3_3_1,expressJoi(sub_schema3.table_3_3_1), teacher_team_handler.journal_director_sub)

// 手动 填报 表3-3-2 教师在国内外重要学术组织任职主要负责人清单
router.post('/International-level/conference-director-template',public.upload_file_callback,excel_parsing3.deal_table_3_3_2,expressJoi(sub_schema3.table_3_3_2), teacher_team_handler.conference_director_sub)

// 手动 填报 表3-3-3 学科主要方向、学科带头人及中青年学术骨干清单
router.post('/International-level/conference-report-template',public.upload_file_callback,excel_parsing3.deal_table_3_3_3,expressJoi(sub_schema3.table_3_3_3), teacher_team_handler.conference_report_sub)

// 手动 填报 表3-3-4 学科主要方向、学科带头人及中青年学术骨干清单
router.post('/International-level/judges-counts-template',public.upload_file_callback,excel_parsing3.deal_table_3_3_4,expressJoi(sub_schema3.table_3_3_4), teacher_team_handler.judges_counts_sub)
