...
expressJoi(sub_schema2.table_2_1_1), pre_view_handler.preview_table)
...
expressJoi(sub_schema2.table_2_2_1_0), pre_view_handler.preview_table)
...
expressJoi(sub_schema2.table_2_2_1_1), pre_view_handler.preview_table)



//  填报中国学位与研究生教育学会教育成果奖情况（2-2-1-2）
router.post('/progress/edu-awards-num/graduate-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_1_2, expressJoi(sub_schema2.table_2_2_1_2), pre_view_handler.preview_table)
//  填报省级教育成果奖情况（2-2-1-3）
router.post('/progress/edu-awards-num/province-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_1_3, expressJoi(sub_schema2.table_2_2_1_3), pre_view_handler.preview_table)

//  填报出版教材质量（2-2-2-1）
router.post('/progress/major-class/publish-quality-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_2_1, expressJoi(sub_schema2.table_2_2_2_1), pre_view_handler.preview_table) 
//  填报国家级一流课程建设情况（2-2-2-3）
router.post('/progress/major-class/nation-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_2_3, expressJoi(sub_schema2.table_2_2_2_3),pre_view_handler.preview_table)
//  填报省级一流课程建设情况（2-2-2-4）
router.post('/progress/major-class/province-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_2_4, expressJoi(sub_schema2.table_2_2_2_4), pre_view_handler.preview_table)

//  填报人才培养平台/基地建设存量情况（2-2-3-0）
router.post('/progress/personnel-cultivate/platform-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_3_0, expressJoi(sub_schema2.table_2_2_3_0), pre_view_handler.preview_table) 
//  填报国家级人才培养平台/基地建设存量情况（2-2-3-1）
router.post('/progress/personnel-cultivate/nation-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_3_1, expressJoi(sub_schema2.table_2_2_3_1), pre_view_handler.preview_table) 
//  填报省部级人才培养平台/基地建设存量情况（2-2-3-2）
router.post('/progress/personnel-cultivate/province-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_3_2, expressJoi(sub_schema2.table_2_2_3_2), pre_view_handler.preview_table) 

//  填报硕士导师和博士导师情况（2-2-4）
router.post('/progress/master-doctoral-tutor-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_4, expressJoi(sub_schema2.table_2_2_4), pre_view_handler.preview_table) 
//  填报给本科生上课的正教授人数（2-2-5）
router.post('/progress/professor-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_5, expressJoi(sub_schema2.table_2_2_5), pre_view_handler.preview_table) 
//  填报本科生、硕士生、博士生（含留学生）国内外竞赛获奖项目清单（2-2-6）
router.post('/progress/student-competition-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_6, expressJoi(sub_schema2.table_2_2_6), pre_view_handler.preview_table) 
//  填报本科生、硕士生、博士生（含留学生）发表的代表性论文清单（2-2-7）
router.post('/progress/student-paper-template', public.upload_file_callback, excel_parsing2.deal_table_2_2_7, expressJoi(sub_schema2.table_2_2_7), pre_view_handler.preview_table) 
...
router.post('/graduate-employment/degree-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_3_1, expressJoi(sub_schema2.table_2_3_1), pre_view_handler.preview_table)
//  填报学科领域突出贡献者情况（2-3-2）
router.post('/graduate-employment/discipline-pioneer-template', public.upload_file_callback, excel_parsing2.deal_table_2_3_2, expressJoi(sub_schema2.table_2_3_2), pre_view_handler.preview_table)

/**
 *   2-4 国际合作交流
 */
//  填报来本学科攻读学位的国（境）外留学生（本、硕、博）及博士后、交流学者情况（2-4-1）
router.post('/international-contacts/scholar-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_4_1,expressJoi(sub_schema2.table_2_4_1), pre_view_handler.preview_table)
//  填报本科生、硕士生、博士生参加本领域国内外重要学术会议并作报告人员清单（2-4-2）
router.post('/international-contacts/conference-counts-template', public.upload_file_callback, excel_parsing2.deal_table_2_4_2,expressJoi(sub_schema2.table_2_4_2), pre_view_handler.preview_table)
