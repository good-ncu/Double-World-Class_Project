 ...
 */
// 4-1-1-0
router.post('/research-innovate/teacher-prize/prize-counts-template', public.upload_file_callback, excel_parsing1.deal_table_4_1_1_0, expressJoi(sub_schema4.table_4_1_1_0), research_handler.teacher_prize_prize_counts_sub)
// 4-1-1-1
router.post('/research-innovate/teacher-prize/nation-counts-template', public.upload_file_callback, excel_parsing1.deal_table_4_1_1_1, expressJoi(sub_schema4.table_4_1_1_1), research_handler.teacher_prize_nation_counts_sub)
// 4-1-1-2
router.post('/research-innovate/teacher-prize/province-counts-template', public.upload_file_callback, excel_parsing1.deal_table_4_1_1_2, expressJoi(sub_schema4.table_4_1_1_2), research_handler.teacher_prize_province_counts_sub)

// 4-1-2
router.post('/research-innovate/teacher-prize/book-counts-template', public.upload_file_callback, excel_parsing1.deal_table_4_1_2, expressJoi(sub_schema4.table_4_1_2), research_handler.teacher_prize_book_counts_sub)

// 4-1-3-0
router.post('/research-innovate/paper-list/all-counts-template', public.upload_file_callback, excel_parsing1.deal_table_4_1_3_0, expressJoi(sub_schema4.table_4_1_3_0), research_handler.paper_list_all_counts_sub)
// 4-1-3-1
router.post('/research-innovate/paper-list/top-counts-template', public.upload_file_callback, excel_parsing1.deal_table_4_1_3_1, expressJoi(sub_schema4.table_4_1_3_1), research_handler.paper_list_top_counts_sub)
// 4-1-3-2
router.post('/research-innovate/paper-list/good-counts-template', public.upload_file_callback, excel_parsing1.deal_table_4_1_3_2, expressJoi(sub_schema4.table_4_1_3_2), research_handler.paper_list_good_counts_sub)
// 4-1-3-3
router.post('/research-innovate/paper-list/other-counts-template', public.upload_file_callback, excel_parsing1.deal_table_4_1_3_3, expressJoi(sub_schema4.table_4_1_3_3), research_handler.paper_list_other_counts_sub)

// 4-1-4
router.post('/research-innovate/design-display-template', public.upload_file_callback, excel_parsing1.deal_table_4_1_4, expressJoi(sub_schema4.table_4_1_4), research_handler.design_display_sub)
