...
exports.deal_table_2_2_1_0 = function(req,res,next){
    ...
    const ex = nodeXlsx.parse(`upload/${up_file.originalname}`)	//读取excel表格
    let excel_content = ex[0].data	//下方ex1是读取出来的数组，数组长度取决于Excel文件的工作表(sheet),取出excel文件中的第一个工作表中的全部数据
    let award_ltype = 'award_ltype' ;
    let award_name = 'award_name' ;
    let award_type = 'award_type'
    ...
    for(let i=0,len=excel_content.length;i<len;i++){
        ...
        data[i]={}
        data[i][award_ltype]=excel_content[i][0];
        data[i][award_name]=excel_content[i][1]
        data[i][award_type]=excel_content[i][2];
        data[i][award_level]=excel_content[i][3]
        data[i][tch_name]=excel_content[i][4];
...
//deal_table_2_2_1_1() pass
exports.deal_table_2_2_1_1 = function(req,res,next){
    const up_file = req.file
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
    const ex = nodeXlsx.parse(`upload/${up_file.originalname}`)	//读取excel表格
...
//deal_table_2_2_1_2() pass
exports.deal_table_2_2_1_2 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_2_1_3() pass
exports.deal_table_2_2_1_3 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_2_2_1() pass
exports.deal_table_2_2_2_1 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_2_2_3() pass
exports.deal_table_2_2_2_3 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_2_2_4() pass
exports.deal_table_2_2_2_4 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_2_3_0() pass
exports.deal_table_2_2_3_0 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_2_3_1() pass
exports.deal_table_2_2_3_1 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_2_3_2() pass
exports.deal_table_2_2_3_2 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_2_4() pass
exports.deal_table_2_2_4 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_2_5() pass
exports.deal_table_2_2_5 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_2_6() pass
exports.deal_table_2_2_6 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
    ...
    for(let i=0,len=excel_content.length;i<len;i++){
        ...
        data[i]={}
        data[i][award_date]=excel_content[i][0];
        data[i][award_name]=excel_content[i][1];
        data[i][award_work]=excel_content[i][2];
        data[i][award_level]=excel_content[i][3];
        data[i][org_name]=excel_content[i][4];
        data[i][org_type]=excel_content[i][5];
...
//deal_table_2_2_7() pass
exports.deal_table_2_2_7 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_3_1() nopass
exports.deal_table_2_3_1 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_3_2() 
exports.deal_table_2_3_2 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
//deal_table_2_4_1()
exports.deal_table_2_4_1 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
...
// deal_table_2_4_2()
exports.deal_table_2_4_2 = function(req,res,next){
    const up_file = req.file
    console.log(up_file);
    fs.renameSync(up_file.path, `upload/${up_file.originalname}`)
    ///*读取excel文件*/
